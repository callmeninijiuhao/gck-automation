...
export function buildEmailHtml(
  ...
  return `
    ...
    <h2 style="margin:0 0 6px">Bundle Level Analysis — Daily Brief — ${dateLabel}</h2>
    ${noticeHtml()}
    ...
    <br>
    <p style="color:#999;font-size:10pt">Auto-generated by GCK Automation — Bundle Level Analysis (Daily Brief)</p>
    </body></html>
  `;
}
